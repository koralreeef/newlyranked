...
async function buildFull(map, ind, user, m) {
  ...
  if (mod != "") {
    scores = await seasonScores.findAll({
  ...
  for (let i = 0; i < scores.length; i++) {
    ...
    if (scores.length < 1) {
      ...
      userScore = ("**#" + index + "** **__[" + current.username + "](https://osu.ppy.sh/users/" + current.user_id + ")__** • **" + current.misscount + "** <:miss:1324410432450068555> ** " + current.mods + "**  <t:" + timestamp + ":R> " + season + "\n **"
  ...
  if (scoreString != "**no scores yet :(**") {
    ...
    for (scor in scores) {
      ...
      if (current.user_id == user) {
        scoreString = scoreString + ("**#" + index + "** **__[" + current.username + "](https://osu.ppy.sh/users/" + current.user_id + ")__** • **" + current.misscount + "** <:miss:1324410432450068555> ** " + current.mods + "**  <t:" + timestamp + ":R> " + season + "\n **"
          + current.accuracy + "%  • ** **" + current.combo + "x**/" + current.max_combo + " • " + score.toLocaleString() + "\n")
        selfScore = selfScore + ("**#" + index + "** **__[" + current.username + "](https://osu.ppy.sh/users/" + current.user_id + ")__** • **" + current.misscount + "** <:miss:1324410432450068555> ** " + current.mods + "**  <t:" + timestamp + ":R> " + season + "\n **"
          + current.accuracy + "%  • ** **" + current.combo + "x**/" + current.max_combo + " • " + score.toLocaleString() + "\n")
      } else {
        scoreString = scoreString + ("**#" + index + "** **[" + current.username + "](https://osu.ppy.sh/users/" + current.user_id + ")** • **" + current.misscount + "** <:miss:1324410432450068555> ** " + current.mods + "**  <t:" + timestamp + ":R> " + season + "\n **"
          + current.accuracy + "%  • ** **" + current.combo + "x**/" + current.max_combo + " • " + score.toLocaleString() + "\n")
      }
...
async function buildEmbed(map, ind, maxIndex, user) {
  let mods = ""
  if (map.required_mods == 3) mods = "+DTHR"
  else if (map.required_mods == 2) mods = "+DT"
  else if (map.required_hr == 1) mods = "+HR"
  //console.log(map)
  ...
  if (scores.length < 1) {
    ...
    for (score in scores) {
      ...
      if (bro.user_id == user) {
        scoreArray = scoreArray + ("**#" + index + "** **__[" + bro.username + "](https://osu.ppy.sh/users/" + scores[score].user_id + ")__** • **" + bro.misscount + "** <:miss:1324410432450068555> ** " + bro.mods + "**  <t:" + timestamp + ":R> " + season + "\n **"
          + bro.accuracy + "%  • ** **" + bro.combo + "x**/" + bro.max_combo + " • " + bro.score.toLocaleString() + "\n")
      } else {
        scoreArray = scoreArray + ("**#" + index + "** **[" + bro.username + "](https://osu.ppy.sh/users/" + scores[score].user_id + ")** • **" + bro.misscount + "** <:miss:1324410432450068555> ** " + bro.mods + "**  <t:" + timestamp + ":R> " + season + "\n  **"
          + bro.accuracy + "%  • ** **" + bro.combo + "x**/" + bro.max_combo + " • " + bro.score.toLocaleString() + "\n")
      }
    }
  }
